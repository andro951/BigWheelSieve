...
int main() {
    ...
    std::cout << "Eratosthenes Sieve Time: " << simpleSieveTime << " microseconds" << ", primesCount: " << simpleSievePrimes.size() << std::endl;
    ...
    std::cout << "Sundaram Sieve Time: " << sundaramTime << " microseconds" << ", primesCount: " << sundaramPrimes.size() << std::endl;
    //PrintVector(sundaramPrimes, "Sundaram Sieve Primes");
    */
    std::vector<int> atkinPrimes;
    long atkinTime = SieveOfAtkin(atkinPrimes);
    std::cout << "Atkin Sieve Time: " << atkinTime << " microseconds" << ", primesCount: " << atkinPrimes.size() << std::endl;
    ...
    std::cout << "Big Wheel Sieve Time: " << bigWheelSieveTime << " microseconds" << ", primesCount: " << bigWheelSievePrimes.size() << std::endl;
